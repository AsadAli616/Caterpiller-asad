...
export default function Sec7({Bot}){
    return<>
    <div className="border-none border-none-black flex flex-col items-center justify-center py-[5vw]">
        ...
        <div className="flex justify-center gap-4 py-[1.4vw] items-center">
  ...
  <div className=" lg:w-[80vw]   mx-auto flex  py-[3vw] border-none border-none-black  md:flex-row-reverse md:flex-nowrap flex-wrap flex-col">
    <div className="w-1/4 border-none border-none-black  md:mx-0 pt-4 mx-auto  md:text-left md:mt-0 ">
...
<nav className="list-none text-start  " >
  ...
  <div className=" border border-[#242426] ">
    ...
    <div className="  w-[84vw] py-3 mx-auto  px-5 flex flex-wrap flex-col sm:flex-row">
      <p className=" text-black font-[600] text-[10px]   sm:text-left">
